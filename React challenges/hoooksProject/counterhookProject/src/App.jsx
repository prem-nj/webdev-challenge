    ...
    <div className='flex  items-center justify-center   mw-full h-screen '>
      ...
      <div className='flex flex-col  relative items-center w-1/2 h-1/2 justify-center rounded-4xl bg-gray-800'>
        <div className='buttons flex gap-10  justify-center items-center w-1/2 h-1/2 rounded-4xl bg-white-200'>
          ...
          {/* <button className='decrease rounded-2xl w-1/2 h-1/3 text-2xl text-white uppercase  bg-amber-100 px-10'><span className='text-black ' onClick={increase}>decrease</span></button> */}
          <button className='decrease rounded-2xl  h-1/3 text-2xl text-white uppercase  bg-amber-100 px-10'><p className='text-black text-center text-nowrap'>jump by 5</p></button>
        </div>
      </div>
